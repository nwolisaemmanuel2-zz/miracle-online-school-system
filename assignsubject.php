            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">ASSIGN CLASS SUBJECTS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">ASSIGN CLASS LEVEL SUBJECTS</li>
                        </ol>
                    </div>
                    <div class="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
										 <?php $levellist = classlevellist(); $i=1;?>
										 <?php while($level = mysqli_fetch_assoc($levellist)){ ?>
												<tr>
													<td><?php echo $i;?></td>
													<td><?php echo $level["levelname"];?></td>
													<td><?php echo $level["leveldescription"];?></td>
													<td><?php echo $level["levelorder"];?></td>
													<td><a href="levelsubject.php?levelid=<?php echo $level["levelid"];?>"  class="esubject" name=""><span class="icon-Books" title="Set Subjects"></span></a></td>
												</tr>
										 <?php  $i++; ?>
										 <?php } ?>
                                        </tbody>
