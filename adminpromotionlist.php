            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">HEADTEACHER APPROVE PROMOSTIONS</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
										 <?php $classeslist = classlistpromotion(); $i=1;?>
										 <?php while($class = mysqli_fetch_assoc($classeslist)){ ?>
												<tr>
													<td><?php echo $i;?></td>
													<td><?php echo $class["classname"];?></td>
													<td><?php echo $class["classdescription"];?></td>
													<td><a href="adminpromotion.php?classid=<?php echo $class["classid"];?>"  class="esubject" name=""><span class=" fa fa-eye" title="Promote Students"> View</span></a></td>
												</tr>
										 <?php  $i++; ?>
										 <?php } ?>
                                        </tbody>
