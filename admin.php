...
<body class="fix-header fix-sidebar card-no-border">
                                ...
                                <ul class="dropdown-user">
                                    ...
                                    <li>
                                       <div class="dw-user-box">
                                            <div class="u-img"><img src="<?php if($image == ""){echo "assets/images/icon/default.png";}else{ echo $image; } ?>" alt="user"></div>
                                            <div class="u-text">
                                                <h4><?php echo setfullname($sid);?></h4>
                                                <p class="text-muted"><?php echo staffemail($sid); ?></p><a href="profile.php" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">SYSTEM USERS </h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-7 align-self-center text-right d-none d-md-block">
                        <button type="button" data-toggle="modal" data-target="#newusermodal" class="btn btn-info"><i class="fa fa-plus-circle"></i> Create New</button>
                    </div>
                    <div class="">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $userresult = userlist(); $i = 1;?>
											 <?php while($user = mysqli_fetch_assoc($userresult)){?>
											 <tr>
											<td><?php echo $i; ?></td>
											<td><?php echo setstaffid($user["usid"]);?></td>
											<td><?php echo setfullname($user["usid"]);?></td>
											<td class="center"><?php if($user["usertype"] == 1){echo "ADMIN";}else{echo "USER";}?></td>
											<td class="center"><?php if($user["ustatus"] == 1){echo "ACTIVE";}else{echo "INACTIVE";}?></td>
											<td class="center"><a href="" data-toggle="modal" class="uedit" data-target="#editusermodal" ustatus="<?php echo $user["ustatus"];?>" utype="<?php echo $user["usertype"];?>" usid="<?php echo $user["usid"];?>" name="<?php echo setfullname($user["usid"]);?>" value="<?php echo setstaffid($user["usid"]);?>"><span class="icon-Pen-2" title="Edit User"></span></a> &nbsp; &nbsp; <a href="" value="<?php echo $user["usid"];?>" name="<?php echo setfullname($user["usid"]);?>" class="remove"><span class="icon-Remove"></span></a></td>
											</tr>
											<?php $i++; ?>
											<?php } ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="frmuser">
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Staff List:</label>
                                                        <select class="form-control" id="staffsid" name="staffsid">
															<option value="">Select Staff</option>
															<?php $activestaff = notuserstaff();?>
															<?php while($staff = mysqli_fetch_assoc($activestaff)){?>
																<?php echo "<option value='".$staff["sid"]."'>".$staff["staffsurname"]." ".$staff["staffothername"]." &nbsp; &nbsp;".$staff["staffid"]."</option>";?>
															<?php } ?>
														</select>
                                                    </div>
                                                    <div class="form-group">
													...
													<div class="form-group">
                                                        <label for="recipient-name" class="control-label">Default Password:</label>
                                                        <input type="text" placeholder="12345" class="form-control" readonly>
                                                    </div>
								...
								<div id="editusermodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="frmedituser">
													<input type="hidden" class="form-control" name="usersid" id="usersid" >
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
													 ...
													 <div class="form-group">
                                                        <label for="recipient-name" class="control-label">User Status:</label>
													...
													<div class="form-group">
                                                        <label for="recipient-name" class="control-label">Reset Password:</label><br />
                                                        &nbsp; Yes <input type="radio" name="reset" value="1" required>&nbsp; &nbsp;
														No <input type="radio" name="reset" value="0" required>
                                                    </div>
   ...
   <?php include('timeout.php'); ?>
	...
	$('#frmuser').submit(function(){
		$.ajax({
			url : 'php/user/newuserprocess.php',
			type : 'POST',
	...
	$('#frmedituser').submit(function(){
		$.ajax({
			url : 'php/user/edituserprocess.php',
			type : 'POST',
			data : new FormData(this),
			contentType: false,
			processData : false,
			success : function(data){
				switch(Number(data)){
					...
					break ;
					case 3:
					alert("User Updating Successfully.");
					window.location = "admin.php";
					break ;
					default:
					alert("Sorry, Fatal error occured, report to your admin.");
...
$('.remove').click(function(){
	...
	if(confirm('You are about to remove ['+uname+'] as a User.')){
		$.ajax({
			url : 'php/user/removeuserprocess.php',
			type : 'POST',
			data : {sid : sid},
			success : function(data){
				switch(Number(data)){
					...
					break ;
					case 2:
					alert("User Removing Failed.");
					break ;
					case 3:
					alert("User Removing Successfully.");
					window.location = "admin.php";
					break ;
					case 4:
					alert("You cannot remove a user with activity in the system.");
					break ;
					default:
					alert("Sorry, Fatal error occured, report to your admin.");
				}
